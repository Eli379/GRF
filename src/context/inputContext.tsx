...
import {InputContext, grfContext} from '../components/Calc_main';
...
export const InputProvider = (props: any) => {
    ...
    const [GRF, set_GRF] = React.useState(React.useContext(grfContext));
    ...
    return (
      <Card>
          ...
          <InputContext.Provider value={Input}>
              ...
              <Redundancy_section
                setState={set_Input}
                setGRF={set_GRF} state={Input}/>
          </InputContext.Provider>
          {/* <Typography level="h1" variant="outlined" color="success">
              GRF = 0.23
          </Typography>           */}
